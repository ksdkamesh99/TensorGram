...
**1.** Fork [this](https://github.com/ksdkamesh99/TensorGram) repository.
Click on the <a href="https://github.com/ksdkamesh99/TensorGram"><img src="https://img.icons8.com/ios/24/000000/code-fork.png"></a> symbol at the top right corner.

**2.** Clone the forked repository. Open terminal and type:

```bash
git clone https://github.com/<your-github-username>/TensorGram.git
```
...
**9.** **Congratulations!** Sit and relax, you've made your contribution to [TensorGram](https://github.com/ksdkamesh99/TensorGram) project.
...
[![built with love](https://forthebadge.com/images/badges/built-with-love.svg)](https://github.com/ksdkamesh99/TensorGram)
</p>
